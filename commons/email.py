...
#        extra_msg = u"""คุณจะต้องส่งหลักฐานเพิ่มเติม ภายในวันที่ 15 ธ.ค. นี้  โดยใช้วิธีส่งแบบออนไลน์เช่นเดิม"""
        extra_msg = u"""คุณจะต้องส่งหลักฐานเพิ่มเติม ภายในวันที่ 18 ธ.ค. นี้  โดยใช้วิธีส่งแบบออนไลน์เช่นเดิม"""
    else:
        extra_msg = u"""คุณจะต้องส่งหลักฐานเพิ่มเติม ผ่านทางระบบออนไลน์ ภายในวันที่ 18 ธ.ค. นี้ โดยระบบจะเริ่มเปิดให้ส่งภายในวันที่ 17 ธ.ค. 52"""
...
อย่างไรก็ตาม *** คณะจะรับหลักฐานที่ส่งทางไปรษณีย์ 
ที่ประทับตราไม่เกินวันที่ 15 ธ.ค. 2552 เท่านั้น ***

ถ้าคุณส่งหลักฐานเพิ่มเติมทางไปรษณีย์หลังจากวันที่ 15 ธ.ค. 2552
คุณจะต้องส่งใหม่อีกครั้ง ผ่านทางระบบรับเอกสารเพิ่มเติมแบบออนไลน์เท่านั้น
...
ระบบนี้จะเปิดให้ส่งได้ถึงวันที่ 18 ธ.ค. นี้เท่านั้น
